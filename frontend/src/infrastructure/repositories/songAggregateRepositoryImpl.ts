import { AutoGenerated, DeepOmitAutoGenerated, DeepProcess, Id } from '../../domain/shared/types';
...
import { createSong, deleteSong, fetchAllSongs, fetchSongDetails, updateSong } from '../services/api';
