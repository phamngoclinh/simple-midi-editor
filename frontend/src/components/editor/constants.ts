...
export const MAX_DURATION_DEFAULT = 60; // Duration mặc định nếu Song chưa có TotalDuration (60 giây)

// Kiểu dáng
export const PRIMARY_GRID_COLOR = '#444'; // Màu cho vạch chính (10 giây)
