    ...
    <div style={backdropStyle}>
      ...
      <div className="relative z-10 w-full max-w-[800px] bg-surface-dark rounded-xl shadow-2xl border border-border-dark flex flex-col max-h-[90vh] animate-fade-in-up">
        ...
        <div
          ...
          <button
            onClick={onClose}
            className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-transparent text-white font-bold leading-normal tracking-[0.015em] hover:bg-white/5 border border-border-dark transition-colors">
